...
\textbf{*** Insert Jargon about Good Numbers Here ***}
...
\begin{proof}
  ...
  In particular, for $\lambda_{**}$, the only tableaux which can remove a cell to yield $D^{(n,n-2)'}$ are $(n+1,n-2)'$, $(n,n-1)'$, and $(n,n-2,1)'$ as illustrated in Figure \ref{OddRes};
...
\begin{proposition}
  ...
  Then, $\Res_{B}^A V \simeq \Res_{B'}^a V$.
\end{proposition}
