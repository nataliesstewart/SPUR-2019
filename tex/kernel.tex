...
\vspace{5mm}
We will characterize our kernel in a recursive fashion. To motivate this characterization, consider the following lemma. In simpler terms, this lemma states that if a basis element $\beta$ has some sub-matching $\beta(a,b)$, we may act on $\beta$ as if we are acting on $\beta(a,b)$.
...
\begin{enumerate}
	...
	\item Use lemma 3.1 to finish the proof through induction.
\end{enumerate}

\vspace{10mm}
\begin{proof}
	
	Need more specific notation for the rainbow elements of specific representations.
