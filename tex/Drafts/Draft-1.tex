  ...
  {\color{orange} Literature review and motivation goes here.}\cite{Kleshchev} 
...
\begin{proof}
  ...
  In order to use Proposition \ref{Combinatorics}, suppose either $e \nmid 4$ or $r \neq 0$.
...
Now let's prove that $V^3_{\vs\vp}$ is irreducible;
