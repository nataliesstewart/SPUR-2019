...
\section{Introduction} 
  ...
  {\color{orange} Literature review and motivation goes here.} 
  ...
  Let $S^{(n+r,n)}$ be the Specht module corresponding to the young diagram with two rows with height difference $r$, and let $D^{(n+r,n)}$ be the corresponding irreducible quotient.
  ...
  we will prove that $M_{2n+r}^r$ and $S^{(n+r,n)}$ are isomorphic as representations in the case that $e > n$ and $S^{(n+r,n)}$ is irreducible.
...
All data will be generated via tools available on \underline{\href{https://github.com/nataliesstewart/Hecke-Heuristics}{github}}.\footnote{The full URL to the repository is \underline{\href{https://github.com/nataliesstewart/Hecke-Heuristics}{https://github.com/nataliesstewart/Hecke-Heuristics}}.}
