import cmath
import numpy
import generalized_crossingless as crossingless
import time
import csv
import math

def make_matrix_generalized(n,q,restriction = 0,r=0):
    """
    ...
    basisraw = crossingless.generate_basis_generalized(n,q,r)
    basis = [crossingless.module_element(n,{b:1},q,r) for b in basisraw]
...
def kernel_dimension(n,q,restriction=1,r=0):
    """
